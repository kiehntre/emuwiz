...
| Japanese PCs | D88/HDI/NHD/XDF/DIM | YES | YES | FAMILY | YES | YES | TOSEC | SUMMARY | PARTIAL | PARTIAL | 5 | `disk_format/d88/hdi/x68000`, `pc98_boot_evidence`, `pc98_container_evidence`, `fmtowns_boot_evidence`, `fmtowns_container_evidence`, `x68000_human68k` | disk-format + PC-98/FM Towns/Human68k boot-evidence tests | exact titles, partition/FAT directory walks and launch; raw/optical Towns paths and non-PC-98 Japanese media remain scoped separately |
