...
pub use dolphin_local::{
    ...
    DolphinInstallationType, DolphinLocalDiscoveryRoots, DolphinLocalInstallationType,
    DolphinLocalProfile, DolphinLocalProfileDiscovery, DolphinMatchResult, DolphinMatchState,
    DolphinProfile, DolphinProfileBlocker, DolphinProfileBlockerKind, DolphinProfileDiscovery,
    DolphinProfileDiscoveryRoots, DolphinProfileScope, DolphinSaveInventory, DolphinSettings,
    DolphinSettingsDirectoryState, DolphinTargetPlatform, DolphinTextureInventory,
