...
pub use dolphin_local::{
    ...
    DolphinCheatInventory, DolphinCodeKind, DolphinCommandLine, DolphinConfigInspection,
    DolphinDirectoryIdentity, DolphinDiscContext, DolphinDiscFormat, DolphinDiscoveryError,
    DolphinExecutable, DolphinGameIdMapping, DolphinGameIniFile, DolphinGameIniInventory,
    DolphinGameInspection, DolphinGameRequest, DolphinGameSettingsInspection, DolphinHealth,
    DolphinInspectionError, DolphinInspectionWarning, DolphinInspectionWarningKind,
    DolphinInstallationType, DolphinLaunchBlocker, DolphinLaunchBlockerKind,
    DolphinLocalDiscoveryRoots, DolphinLocalInstallationType, DolphinLocalProfile,
    DolphinLocalProfileDiscovery, DolphinMatchResult, DolphinMatchState,
    ...
    inspect_dolphin_profile, match_dolphin_inventory, parse_dolphin_version,
    resolve_dolphin_native_launch_binding, select_dolphin_profile,
};
...
pub use dolphin_texture_pack::{
    ...
    DOLPHIN_TEXTURE_PACK_SOURCE_MODE, DolphinTexturePackApplyResult, DolphinTexturePackFile,
...
pub use pcsx2_local::{
    ...
    Pcsx2DiscoveryError, Pcsx2Executable, Pcsx2GameInspection, Pcsx2GameRequest, Pcsx2Health,
    Pcsx2InspectionError, Pcsx2InspectionWarning, Pcsx2InspectionWarningKind,
    Pcsx2InstallationType, Pcsx2LaunchBlocker, Pcsx2LaunchBlockerKind, Pcsx2MatchResult,
    Pcsx2MatchState, Pcsx2MemcardInfo, Pcsx2MemcardKind, Pcsx2NativeLaunchBinding,
    Pcsx2PatchCategory, Pcsx2PatchDirectory, Pcsx2PatchDirectoryState, Pcsx2PnachFile,
    Pcsx2PnachInventory, Pcsx2Profile, Pcsx2ProfileBlocker, Pcsx2ProfileBlockerKind,
    Pcsx2ProfileDiscovery, Pcsx2ProfileDiscoveryRoots, Pcsx2ProfileScope, Pcsx2SaveStateInventory,
    Pcsx2SerialMapping, Pcsx2Settings, Pcsx2TextureInventory, Pcsx2UserDirectoryMode,
    discover_pcsx2_profiles, inspect_pcsx2_game, inspect_pcsx2_profile, match_pcsx2_inventory,
    parse_pcsx2_version, resolve_pcsx2_native_launch_binding,
};
pub use pcsx2_pnach::{
