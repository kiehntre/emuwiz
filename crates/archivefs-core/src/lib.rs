...
pub use database::{
    ...
    DatabaseSidecarKind, DiscoveryDetailFilter, DiscoveryDetailRecord, DiscoveryDetailsPage,
    DiscoveryRunId, DiscoveryRunStatus, MANUAL_PLATFORM_SOURCE, MAX_RETAINED_DISCOVERY_RUNS,
    MissingArchiveRemovalResult, PersistedArchive, PersistedSetAuditDependency,
    PersistedSetAuditResult, PlatformAlias, PlatformAssignmentChange, PlatformIdentityApplyOutcome,
    PlatformIdentityConflictDetail, PlatformIdentityEnrichmentSummary, PlatformProvenanceDetails,
    ROMM_PLATFORM_SOURCE, RecentScanAdditions, RegisteredSourceFolder,
    SOURCE_PLATFORM_ASSIGNMENT_SOURCE, ScanPersistSummary, ScanRunCounts, SourceFolderRecord,
    SourceScanStatus, VERIFIED_DAT_PLATFORM_SOURCE, check_database_health, default_database_path,
