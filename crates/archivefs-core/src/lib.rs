...
pub use database::{
    ...
    DatabaseSidecarKind, MANUAL_PLATFORM_SOURCE, MissingArchiveRemovalResult, PersistedArchive,
    PlatformAlias, PlatformAssignmentChange, PlatformIdentityApplyOutcome,
