...
#[test]
fn sis_is_weak_n_gage_evidence_but_n_gage_extension_remains_strong() {
    ...
    assert_eq!(contextual_sis.platform, Some("NGage"));
    assert_eq!(
        contextual_sis.deciding_source,
        Some(DetectionSource::FolderAlias)
    );
}
