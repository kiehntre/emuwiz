...
#[allow(dead_code)]
pub(crate) fn gather_selected_evidence_with_registry(
    path: &Path,
...
pub(crate) fn gather_selected_evidence_with_registry_and_platform(
    path: &Path,
...
/// resolved.
#[allow(dead_code)]
pub(crate) fn gather_selected_evidence_with_registry_at(
    path: &Path,
    no_intro_source_cache: &Mutex<selected_evidence_no_intro::NoIntroSourceCache>,
...
pub(crate) fn gather_selected_evidence_with_registry_at_and_platform(
    path: &Path,
    platform_hint: Option<&str>,
    no_intro_source_cache: &Mutex<selected_evidence_no_intro::NoIntroSourceCache>,
    dat_sources_config_path: Option<&std::path::Path>,
