...
pub(crate) fn setup_check_summary(state: &DoctorScanState) -> home_page::SetupCheckSummary {
...
pub(crate) fn doctor_summary_text(report: &DoctorReport) -> String {
    let passed = report
        .checks
        .iter()
...
pub(crate) fn doctor_report_text(report: &DoctorReport) -> String {
    let mut lines = vec![
...
pub(crate) fn show_doctor_checks_panel(ui: &mut egui::Ui, doctor: Option<&DoctorReport>) {
...
#[test]
pub(crate) fn benign_loose_rom_doctor_findings_use_a_friendly_summary() {
