    ...
    sender
        .send((
            ...
            DoctorGathered {
                ...
                azahar_cemu_readiness: Gathered::NotLoaded("stale"),
                melonds_mgba_readiness: Gathered::NotLoaded("stale"),
                desmume_mesen_readiness: Gathered::NotLoaded("stale"),
                rmg_sameboy_readiness: Gathered::NotLoaded("stale"),
                linux_emulator_installations: Gathered::NotLoaded("stale"),
                arcade_dat_version: Gathered::NotLoaded("stale"),
                arcade_readiness: Gathered::NotLoaded("stale"),
                scummvm_readiness: Gathered::NotLoaded("stale"),
                dosbox_staging_readiness: Gathered::NotLoaded("stale"),
    ...
    sender
        .send((
            ...
            DoctorGathered {
                ...
                azahar_cemu_readiness: Gathered::NotLoaded("not gathered"),
                melonds_mgba_readiness: Gathered::NotLoaded("not gathered"),
                desmume_mesen_readiness: Gathered::NotLoaded("not gathered"),
                rmg_sameboy_readiness: Gathered::NotLoaded("not gathered"),
                linux_emulator_installations: Gathered::NotLoaded("not gathered"),
                arcade_dat_version: Gathered::NotLoaded("not gathered"),
                arcade_readiness: Gathered::NotLoaded("not gathered"),
                scummvm_readiness: Gathered::NotLoaded("not gathered"),
                dosbox_staging_readiness: Gathered::NotLoaded("not gathered"),
