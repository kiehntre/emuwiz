//! RomM provider operation workers and preparation helpers.
//!
//! This module contains the provider-specific execution family used by the
//! RomM GUI controller. UI state and global refresh/history effects remain in
//! the existing romm controller; domain and cache APIs remain in core.
...
use crate::romm_source::{
    RommOperation, RommOperationOutcome, RommProgressEvent, RommSnapshot, VerifyRommSummary,
};
use crate::{romm_browse, romm_config, romm_source};
